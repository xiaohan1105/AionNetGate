...
namespace AionLanucher.Utilty
{
    ...
    class ValidCode
    {
        ...
        internal ValidCode(int len, CodeType ctype)
        {
        ...
        internal enum CodeType { Words, Numbers, Characters, Alphas }
        ...
        internal Stream CreateCheckCodeImage()
        {
            ...
            try
            {
                ...
                LinearGradientBrush brush = new LinearGradientBrush(new Rectangle(0, 0, image.Width, image.Height), Color.DarkGreen, Color.DarkBlue, 1.2f, true);
